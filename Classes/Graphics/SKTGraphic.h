...
extern NSString *const SKTGraphicCanSetDrawingFillKey;
extern NSString *const SKTGraphicCanSetDrawingStrokeKey;
extern NSString *const SKTGraphicIsDrawingFillKey;
extern NSString *const SKTGraphicFillColorKey;
extern NSString *const SKTGraphicIsDrawingStrokeKey;
extern NSString *const SKTGraphicLockedKey;
extern NSString *const SKTGraphicStrokeColorKey;
extern NSString *const SKTGraphicStrokeWidthKey;
extern NSString *const SKTGraphicXPositionKey;
extern NSString *const SKTGraphicYPositionKey;
extern NSString *const SKTGraphicWidthKey;
extern NSString *const SKTGraphicHeightKey;
extern NSString *const SKTGraphicBoundsKey;
extern NSString *const SKTGraphicDrawingBoundsKey;
extern NSString *const SKTGraphicDrawingContentsKey;
extern NSString *const SKTGraphicKeysForValuesToObserveForUndoKey;
extern NSString *const SKTGraphicClosed;  // common ancestor of poly and path.
extern NSString *const SKTGraphicClassNameKey;
...
@protocol SKTHasHandles <NSObject>
...
/* This class is KVC (except for "drawingContents") and KVO (except for the scripting-only properties) compliant for these keys:
 ...
 "locked" (a boolean NSNumber; read-write) - Whether or not changing the bounds, stroke, stroke width, and fill are allowed.
...
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSMutableDictionary *properties;
...
@property (NS_NONATOMIC_IOSONLY, getter = isDrawingFill, readonly) BOOL drawingFill;
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSColor *fillColor;
@property (NS_NONATOMIC_IOSONLY, getter = isDrawingStroke, readonly) BOOL drawingStroke;
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSColor *strokeColor;
@property (NS_NONATOMIC_IOSONLY, readonly) CGFloat strokeWidth;
@property (nonatomic) NSUInteger updateCount;
@property (NS_NONATOMIC_IOSONLY, readonly) BOOL canOpenPolygon;
@property (NS_NONATOMIC_IOSONLY, readonly) BOOL canClosePolygon;
...
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSBezierPath *bezierPathForDrawing;
...
@property (NS_NONATOMIC_IOSONLY, readonly) BOOL canSetDrawingFill;
@property (NS_NONATOMIC_IOSONLY, readonly) BOOL canSetDrawingStroke;
...
@property (NS_NONATOMIC_IOSONLY, readonly) BOOL canMakeNaturalSize;
...
// return self, here in the base class.
